Action()
{
	...
	lr_start_transaction("S04_01_OpenApplication");
	...
	web_add_header("If-None-Match", 
		"b95f93c5aac1caaa8cb67cc686763220ac7a537d");
...
/*Correlation comment - Do not change!  Original value='3adba331-ab10-46c4-9e7f-0a10de669bd7' Name ='Csrf_Token_Id' Type ='Manual'*/
...
//		LAST);
	...
	lr_end_transaction("S04_01_OpenApplication",LR_AUTO);
...
//		"chromecrx-81.0.4044.138");
	...
	lr_start_transaction("S04_02_Login");
...
//
//	web_add_header("X-Goog-Update-AppId", 
//		"ihnlcenocehgdaegdmhbidjhnhdchfmm,gcmjkmgdlgnkkcocmoeiminaijmmjnii,llkgjffcdpffmhiakmfcdcblohccpfmo,hfnkpimlhhgieaddgfemjhofmfblmnib,hnimpnehoodheedghdeeijklkeaacbdc,khaoiebndkojlmppeemjhbpbandiljpe,aemomkdncapdnfajjbbcbdebjljbpmpj,ehgidpndbllacpjalkiimkbadgjfnnmc,mimojjlkmoijpicakmndhoigimigcmbb,giekcmmlnklenlaomppkphknjmnnpneh,oimompecagnajdejgnnjijobebaeigek,gkmgaooipdjhmangpemjhigmamcehddo,copjbmjbojbakpaedmpkhmiplmmehfck,jflookgnkcckhobaglndicnbbgbonegd,ggkkehgbnfjpeggfpleeakpidbkibbmn,"
...
//		"*/*");
	...
	web_url("caseByStatus", 
		"URL={URL}/signal/dashboard/caseByStatus?_=1590477579532", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t94.inf", 
	...
	web_url("sideBar", 
		"URL={URL}/signal/dashboard/sideBar?_=1590477579531", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t95.inf", 
	...
	web_url("ahaByStatus", 
		"URL={URL}/signal/dashboard/ahaByStatus?_=1590477579534", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t96.inf", 
	...
	web_url("aggAlertByStatus", 
		"URL={URL}/signal/dashboard/aggAlertByStatus?_=1590477579533", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t97.inf", 
	...
	web_url("alertByDueDate", 
		"URL={URL}/signal/dashboard/alertByDueDate?_=1590477579535", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t98.inf", 
	...
	web_url("getProductByStatus", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Aggregate%20Case%20Alert&_=1590477579537", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t99.inf", 
	...
	web_url("getProductByStatus_2", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Single%20Case%20Alert&_=1590477579536", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t100.inf", 
...
//		"empty");
	...
	web_url("alertList", 
		"URL={URL}/signal/dashboard/alertList?_=1590477579539", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t105.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("signalList", 
		"URL={URL}/signal/dashboard/signalList?_=1590477579540", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t109.inf", 
...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_url("actionList", 
		"URL={URL}/signal/dashboard/actionList?_=1590477579541", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t111.inf", 
...
//		"*/*");
	...
	lr_end_transaction("S04_02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S04_03_NavigateTriggeredAlertsQualitativeReview");
...
/*Correlation comment - Do not change!  Original value='3adba331-ab10-46c4-9e7f-0a10de669bd7' Name ='CFSR_TokenId' Type ='Manual'*/
//	web_reg_save_param_regexp(
//		"ParamName=CFSR_TokenId",
//		"RegExp=\\ content=\"(.*?)\"/>\\\n\\ \\ \\ \\ ",
//		SEARCH_FILTERS,
//		"Scope=Body",
//		"IgnoreRedirections=No",
...
//		LAST);
	...
	web_url("listConfig", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=9&order%5B0%5D%5Bdir%5D=desc&start=0&length=25&search%5Bvalue%5D=&search%5Bregex%5D=false&_=1590477625062", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/review", 
		"Snapshot=t128.inf", 
	...
	lr_end_transaction("S04_03_NavigateTriggeredAlertsQualitativeReview",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S04_04_ClickOnAlertName");
...
//	web_reg_find("Search=Body",
//		"Text=Disposition changed successfully",
//		LAST);
...
//		"XMLHttpRequest");
	...
	web_url("viewColumnInfo", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id=6559&_=1590477651724", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t158.inf", 
...
//		"XMLHttpRequest");
	...
	web_submit_data("17", 
		"Action={URL}/signal/singleCaseAlert/listByExecutedConfig/{ConfigId}?cumulative=false&adhocRun=false&dashboardFilter=&tagName=&isFilterRequest=false&filters=[]", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t164.inf", 
	...
	lr_end_transaction("S04_04_ClickOnAlertName",LR_AUTO);

	lr_think_time(3);


	lr_start_transaction("S04_05_SelectNCasesandClickonDisposition");
	...
	web_submit_data("changeDisposition", 
		"Action={URL}/signal/singleCaseAlert/changeDisposition", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t173.inf", 
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=selectedRows", "Value=[{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert1}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Altert2}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert3}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert4}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert5}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert6}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert7}},{\""
		"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert8}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alter9}},{\"configObj.id\":14,\"executedConfigObj.id\":{ConfigId},\"alert.id\":{Alert10}}]", ENDITEM, 
	...
	lr_end_transaction("S04_05_SelectNCasesandClickonDisposition",LR_AUTO);

	lr_think_time(3);


	lr_start_transaction("S04_07_Logout");
	...
	lr_end_transaction("S04_07_Logout",LR_AUTO);
