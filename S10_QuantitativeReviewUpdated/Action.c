...
//		LAST);
	...
	web_submit_data("changeDisposition", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=selectedRows", "Value=[{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{ExecConfig_Id},\"alert.id\":{DisposeAlertId1}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{ExecConfig_Id},\"alert.id\":{DisposeAlertId2}}]", ENDITEM, 
