...
//	web_set_max_html_param_len("9999999");
	...
	lr_start_transaction("S02_01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='839090f4-17cc-49c4-9723-64a0d337ef2e' Name ='Csrf_Token_Id' Type ='Manual'*/
...
//		LAST);
	...
	lr_end_transaction("S02_01_OpenApplication",LR_AUTO);
	...
	lr_start_transaction("S02_02_Login");
...
//
//	web_add_header("X-Goog-Update-AppId", 
//		"ihnlcenocehgdaegdmhbidjhnhdchfmm,oimompecagnajdejgnnjijobebaeigek,mimojjlkmoijpicakmndhoigimigcmbb,gcmjkmgdlgnkkcocmoeiminaijmmjnii,aemomkdncapdnfajjbbcbdebjljbpmpj,hfnkpimlhhgieaddgfemjhofmfblmnib,llkgjffcdpffmhiakmfcdcblohccpfmo,gkmgaooipdjhmangpemjhigmamcehddo,hnimpnehoodheedghdeeijklkeaacbdc,khaoiebndkojlmppeemjhbpbandiljpe,ehgidpndbllacpjalkiimkbadgjfnnmc,copjbmjbojbakpaedmpkhmiplmmehfck,ggkkehgbnfjpeggfpleeakpidbkibbmn,bklopemakmnopmghhmccadeonafabnal,jflookgnkcckhobaglndicnbbgbonegd,"
...
//		"*/*");
	...
	web_url("aggAlertByStatus", 
		"URL={URL}/signal/dashboard/aggAlertByStatus?_=1590142549821", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t102.inf", 
	...
	web_url("caseByStatus", 
		"URL={URL}/signal/dashboard/caseByStatus?_=1590142549820", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t103.inf", 
	...
	web_url("sideBar", 
		"URL={URL}/signal/dashboard/sideBar?_=1590142549819", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t104.inf", 
	...
	web_url("ahaByStatus", 
		"URL={URL}/signal/dashboard/ahaByStatus?_=1590142549822", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t105.inf", 
...
//	web_url("{AssingnToId}", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142549826", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/", 
//		"Snapshot=t106.inf", 
...
//		LAST);
	...
	web_url("getProductByStatus", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Aggregate%20Case%20Alert&_=1590142549825", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t107.inf", 
	...
	web_url("getProductByStatus_2", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Single%20Case%20Alert&_=1590142549824", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t108.inf", 
...
//		"{URL}");
	...
	web_url("alertByDueDate", 
		"URL={URL}/signal/dashboard/alertByDueDate?_=1590142549823", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t110.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("alertList", 
		"URL={URL}/signal/dashboard/alertList?_=1590142549827", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t115.inf", 
	...
	web_url("signalList", 
		"URL={URL}/signal/dashboard/signalList?_=1590142549828", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t116.inf", 
...
//	web_url("websocket", 
//		"URL={URL}/signal/stomp/447/pclixm08/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t118.inf", 
//		"Mode=HTTP", 
...
//		"XMLHttpRequest");
	...
	web_url("actionList", 
		"URL={URL}/signal/dashboard/actionList?_=1590142549829", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t119.inf", 
...
//	web_url("{AssingnToId}_2", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142549830", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/", 
//		"Snapshot=t121.inf", 
...
//		LAST);
	...
	lr_end_transaction("S02_02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S02_03_NavigateTriggeredAlertsQualitativeReview");
...
//	web_url("{AssingnToId}_3", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142586114", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/review", 
//		"Snapshot=t134.inf", 
...
//		LAST);
	...
	web_url("listConfig", 
		...
		"columns%5B10%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=9&order%5B0%5D%5Bdir%5D=desc&start=0&length=25&search%5Bvalue%5D=&search%5Bregex%5D=false&_=1590142586113", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/review", 
		"Snapshot=t135.inf", 
...
//	web_url("websocket_2", 
//		"URL={URL}/signal/stomp/502/y9_gbrox/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t136.inf", 
//		"Mode=HTTP", 
...
//	web_url("{AssingnToId}_4", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142586115", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/review", 
//		"Snapshot=t137.inf", 
...
//		LAST);
	...
	lr_end_transaction("S02_03_NavigateTriggeredAlertsQualitativeReview",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S02_04_ClickOnAlertName");
...
//	web_reg_find("Search=Body",
//		"Text=Review History for Current Product",
//		LAST);
	...
	web_url("details", 
		"URL={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/review", 
		"Snapshot=t138.inf", 
...
//		"*/*");
	...
	web_url("highcharts-more-f214354c75a376fd86847242d26a1023.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t139.inf", 
		LAST);
...
//		"*/*");
	...
	web_url("fieldConfigurationManagelement-e1a802ff9b5cad88989e761d50770b53.js", 
...
//		"XMLHttpRequest");
	...
	web_url("viewColumnInfo", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id=6559&_=1590142611388", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t167.inf", 
...
//	web_url("{AssingnToId}_5", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611389", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t169.inf", 
...
//	web_url("websocket_3", 
//		"URL={URL}/signal/stomp/438/h__qopgz/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t172.inf", 
//		"Mode=HTTP", 
...
//		"*/*");
	...
	lr_end_transaction("S02_04_ClickOnAlertName",LR_AUTO);
	...
	web_add_auto_header("Accept", 
		"*/*");
//
//	web_url("{AssingnToId}_6", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611390", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t177.inf", 
...
//		LAST);
	...
	lr_start_transaction("S02_05_ClickOnComments");
	...
	web_url("listComments", 
		"URL={URL}/signal/alertComment/listComments?alertType=Single+Case+Alert&productFamily=0991+Injection&caseNumber={CaseNumber}&productName=caspofungin+acetate&pt=Ventricular+arrhythmia&productId={Product_Id}&assignedTo={AssingnToId}&executedconfigId={Exec_Config_Id}&configId={AlertConfigId}", 
		"Resource=0", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t179.inf", 
		"Mode=HTTP", 
	...
	web_submit_data("saveComment", 
		"Action={URL}/signal/alertComment/saveComment", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t180.inf", 
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=caseJsonObjArray", "Value=[{\"alertType\":\"Single Case Alert\",\"productName\":\"caspofungin acetate\",\"pt\":\"Ventricular arrhythmia\",\"comments\":\"{Comments_Field}\",\"caseNumber\":\"{CaseNumber}\",\"productFamily\":\"{Product_Family}\",\"validatedSignalId\":\"\",\"assignedTo\":{AssingnToId},\"executedConfigId\":15,\"productId\":{Product_Id},\"configId\":12}]", ENDITEM, 
		LAST);
...
//	web_url("{AssingnToId}_7", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611391", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t182.inf", 
...
//		LAST);
	...
	lr_end_transaction("S02_05_ClickOnComments",LR_AUTO);

	lr_think_time(3);
//
//	web_url("{AssingnToId}_8", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611392", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t183.inf", 
...
//		LAST);
	...
	lr_start_transaction("S02_06_UpdateComments");

//	web_url("{AssingnToId}_9", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611393", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t184.inf", 
...
//		LAST);
	...
	lr_end_transaction("S02_06_UpdateComments",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S02_07_UploadAttachment");
	...
	web_url("fetchAttachment", 
		"URL={URL}/signal/singleCaseAlert/fetchAttachment?alertId={AlertId}&_=1590142611394", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t186.inf", 
	...
	web_add_auto_header("Accept", 
		"*/*");
//
//	web_url("{AssingnToId}_10", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611395", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t187.inf", 
...
//		LAST);
	...
	web_submit_data("upload", 
		"Action={URL}/signal/singleCaseAlert/upload", 
		"Method=POST", 
		...
		"Name=attachments", "Value={Attachment_Pdf}", "File=Yes", ENDITEM, 
	...
	web_url("fetchAttachment_2", 
		"URL={URL}/signal/singleCaseAlert/fetchAttachment?alertId={AlertId}&_=1590142611396", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t190.inf", 
...
//	web_url("{AssingnToId}_11", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611397", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t191.inf", 
...
//		LAST);
	...
	lr_end_transaction("S02_07_UploadAttachment",LR_AUTO);

	lr_think_time(3);

//	web_url("{AssingnToId}_12", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611398", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t192.inf", 
...
//		LAST);
	...
	lr_start_transaction("S02_08_ViewHistory");

	web_add_auto_header("Accept", 
		"application/json, text/javascript, */*; q=0.01");

	web_url("listCaseHistory", 
		"URL={URL}/signal/caseHistory/listCaseHistory?caseNumber={CaseNumber}&productFamily=0991%20Injection&alertConfigId={AlertConfigId}&_=1590142611399", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t193.inf", 
	...
	web_url("listSuspectProdCaseHistory", 
		"URL={URL}/signal/caseHistory/listSuspectProdCaseHistory?caseNumber={CaseNumber}&productFamily=0991%20Injection&caseVersion=2&alertConfigId={AlertConfigId}&_=1590142611400", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t194.inf", 
	...
	web_url("historyJustification.hbs", 
		"URL={URL}/signal/assets/app/pvs/hbs-templates/historyJustification.hbs", 
		"Resource=1", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
		"Snapshot=t195.inf", 
		LAST);
...
//	web_url("{AssingnToId}_13", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611401", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t196.inf", 
...
//		LAST);
	...
	lr_end_transaction("S02_08_ViewHistory",LR_AUTO);

	lr_think_time(3);

//	web_url("{AssingnToId}_14", 
//		"URL={URL}/signal/inboxLog/forUser/{AssingnToId}?_=1590142611402", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Exec_Config_Id}", 
//		"Snapshot=t197.inf", 
...
//		LAST);
	...
	lr_start_transaction("S02_09_Logout");
	...
	lr_end_transaction("S02_09_Logout",LR_AUTO);
