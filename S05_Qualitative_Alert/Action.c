...
/*Correlation comment - Do not change!  Original value='919e9f23-7b0c-4bf9-b731-8da9af507814' Name ='CsrfTokenId' Type ='Manual'*/
...
//		"chromecrx-81.0.4044.138");
	...
	lr_start_transaction("S05_02_Login");
...
//
//	web_add_header("X-Goog-Update-AppId", 
//		"ihnlcenocehgdaegdmhbidjhnhdchfmm,mimojjlkmoijpicakmndhoigimigcmbb,llkgjffcdpffmhiakmfcdcblohccpfmo,hnimpnehoodheedghdeeijklkeaacbdc,oimompecagnajdejgnnjijobebaeigek,hfnkpimlhhgieaddgfemjhofmfblmnib,aemomkdncapdnfajjbbcbdebjljbpmpj,giekcmmlnklenlaomppkphknjmnnpneh,gcmjkmgdlgnkkcocmoeiminaijmmjnii,khaoiebndkojlmppeemjhbpbandiljpe,gkmgaooipdjhmangpemjhigmamcehddo,ggkkehgbnfjpeggfpleeakpidbkibbmn,bklopemakmnopmghhmccadeonafabnal,copjbmjbojbakpaedmpkhmiplmmehfck,jflookgnkcckhobaglndicnbbgbonegd,"
...
//		"XMLHttpRequest");
	...
	web_url("ahaByStatus", 
		"URL={URL}/signal/dashboard/ahaByStatus?_=1590409003098", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t96.inf", 
	...
	web_url("sideBar", 
		"URL={URL}/signal/dashboard/sideBar?_=1590409003095", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t97.inf", 
	...
	web_url("caseByStatus", 
		"URL={URL}/signal/dashboard/caseByStatus?_=1590409003096", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t98.inf", 
	...
	web_url("aggAlertByStatus", 
		"URL={URL}/signal/dashboard/aggAlertByStatus?_=1590409003097", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t99.inf", 
	...
	web_url("getProductByStatus", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Single%20Case%20Alert&_=1590409003100", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t100.inf", 
	...
	web_url("alertByDueDate", 
		"URL={URL}/signal/dashboard/alertByDueDate?_=1590409003099", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t101.inf", 
	...
	web_url("getProductByStatus_2", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Aggregate%20Case%20Alert&_=1590409003101", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t102.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("alertList", 
		"URL={URL}/signal/dashboard/alertList?_=1590409003103", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t107.inf", 
...
//	web_concurrent_end(NULL);
	...
	web_url("signalList", 
		"URL={URL}/signal/dashboard/signalList?_=1590409003104", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t110.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("actionList", 
		"URL={URL}/signal/dashboard/actionList?_=1590409003105", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t113.inf", 
...
//		"*/*");
	...
	lr_end_transaction("S05_02_Login",LR_AUTO);

	lr_think_time(3);

	

	lr_start_transaction("S05_03_NavigateQualitativeAlert");
	...
	web_url("common_alert_utils-e15cae7b949ab3dffb7111af1e15f4aa.js", 
		"URL={URL}/signal/assets/app/pvs/alert_utils/common_alert_utils-e15cae7b949ab3dffb7111af1e15f4aa.js", 
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/signal/singleCaseAlert/create", 
		"Snapshot=t120.inf", 
	...
	lr_end_transaction("S05_03_NavigateQualitativeAlert",LR_AUTO);
	...
	lr_start_transaction("S05_04_ClickOn_ProductLookUp");

	lr_end_transaction("S05_04_ClickOn_ProductLookUp",LR_AUTO);

	lr_think_time(3);

	
	lr_start_transaction("S05_05_SearchProduct");
	...
	web_custom_request("searchViews", 
		...
		"Body=contains=PLACEBO+(0653+TABLET+STUDY)&dictionaryLevel=3&ref_level=&exact_search=false&imp=false&dataSource=pva&filters=%7B%7D", 
		LAST);
	...
	web_submit_data("getPreLevelProductParents_2", 
		...
		"Name=currentLang", "Value=en", ENDITEM, 
		"Name=productIds", "Value=100005", ENDITEM, 
		LAST);
	...
	web_submit_data("getPreLevelProductParents_3", 
		...
		"Name=currentLang", "Value=en", ENDITEM, 
		"Name=productIds", "Value=115880", ENDITEM, 
		LAST);
	...
	lr_end_transaction("S05_05_SearchProduct",LR_AUTO);

	lr_think_time(3);	

	lr_start_transaction("S05_06_CreateQuantitativeAlert");
	...
	web_submit_data("run", 
		...
		"Name=productSelection", "Value={\"1\":[],\"2\":[],\"3\":[{\"name\":\"{SearchProduct}\",\"id\":\"{ProductId}\"}],\"4\":[]}", ENDITEM, 
		...
		"Name=alertQuery", "Value=undefined", ENDITEM, 
		...
		"Name=description", "Value=PT_Quali11\r\n", ENDITEM, 
		...
		"Name=scheduleDateJSON", "Value={\"startDateTime\":\"2020-05-26T12:56Z\",\"timeZone\":{\"name\":\"UTC\",\"offset\":\"+00:00\"},\"recurrencePattern\":\"FREQ=DAILY;INTERVAL=1;COUNT=1\"}", ENDITEM, 
...
//		"Name=_suspectProduct", "Value=", ENDITEM,
//		"Name=isSuspectProduct", "Value=false", ENDITEM,
//		"Name=productSelection", "Value={\"1\":[],\"2\":[],\"3\":[{\"name\":\"{SearchProduct} Tablet\",\"id\":\"{ProductId}\"}],\"4\":[]}", ENDITEM,
//		"Name=studySelection", "Value=", ENDITEM,
//		"Name=JSONExpressionValues", "Value=", ENDITEM,
//		"Name=_limitPrimaryPath", "Value=", ENDITEM,
//		"Name=eventSelection", "Value=", ENDITEM,
...
//		"&columns%5B2%5D%5Bdata%5D=frequency&columns%5B2%5D%5Bname%5D=&columns%5B2%5D%5Bsearchable%5D=true&columns%5B2%5D%5Borderable%5D=false&columns%5B2%5D%5Bsearch%5D%5Bvalue%5D=&columns%5B2%5D%5Bsearch%5D%5Bregex%5D=false&columns%5B3%5D%5Bdata%5D=runDate&columns%5B3%5D%5Bname%5D=&columns%5B3%5D%5Bsearchable%5D=true&columns%5B3%5D%5Borderable%5D=true&columns%5B3%5D%5Bsearch%5D%5Bvalue%5D=&columns%5B3%5D%5Bsearch%5D%5Bregex%5D=false&columns%5B4%5D%5Bdata%5D=executionTime&columns%5B4%5D%5Bname%5D=&"
//		"columns%5B4%5D%5Bsearchable%5D=true&columns%5B4%5D%5Borderable%5D=false&columns%5B4%5D%5Bsearch%5D%5Bvalue%5D=&columns%5B4%5D%5Bsearch%5D%5Bregex%5D=false&columns%5B5%5D%5Bdata%5D=owner&columns%5B5%5D%5Bname%5D=&columns%5B5%5D%5Bsearchable%5D=true&columns%5B5%5D%5Borderable%5D=true&columns%5B5%5D%5Bsearch%5D%5Bvalue%5D=&columns%5B5%5D%5Bsearch%5D%5Bregex%5D=false&columns%5B6%5D%5Bdata%5D=executionStatus&columns%5B6%5D%5Bname%5D=&columns%5B6%5D%5Bsearchable%5D=true&columns%5B6%5D%5Borderable%5D="
//		"false&columns%5B6%5D%5Bsearch%5D%5Bvalue%5D=&columns%5B6%5D%5Bsearch%5D%5Bregex%5D=false&order%5B0%5D%5Bcolumn%5D=3&order%5B0%5D%5Bdir%5D=desc&start=0&length=50&search%5Bvalue%5D=&search%5Bregex%5D=false&searchString=&direction=desc&sort=runDate&status=GENERATING&alertType=SINGLE_CASE_ALERT&_=1590409189986", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/configuration/executionStatus?alertType=SINGLE_CASE_ALERT", 
//		"Snapshot=t177.inf", 
...
//		"XMLHttpRequest");
	...
	lr_end_transaction("S05_06_CreateQuantitativeAlert",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S05_07_Logout");
	...
	lr_end_transaction("S05_07_Logout",LR_AUTO);
