...
//		LAST);
	...
	web_submit_data("changePriorityOfAlert", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=selectedRows", "Value=[{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\""
		"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\""
		"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\""
		"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\""
		":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},"
		"\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\""
		"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}},{\"configObj.id\":{AlterConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlterId}]", ENDITEM, 
