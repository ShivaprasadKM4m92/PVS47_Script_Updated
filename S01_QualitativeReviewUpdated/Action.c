...
//		"application/json, text/javascript, */*; q=0.01");
	...
	web_submit_data("15", 
		"Action={URL}/signal/singleCaseAlert/listByExecutedConfig/{Config_Id}?cumulative=false&adhocRun=false&dashboardFilter=&tagName=&isFilterRequest=false&filters=[]", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={Config_Id}", 
		"Snapshot=t166.inf", 
...
//		LAST);
	...
	web_submit_data("changePriorityOfAlert", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=selectedRows", "Value=[{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\""
		"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\""
		"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\""
		"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\""
		":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},"
		"\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\""
		"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}},{\"configObj.id\":{AlertConfigId},\"executedConfigObj.id\":{Config_Id},\"alert.id\":{AlertId}}]", ENDITEM, 
