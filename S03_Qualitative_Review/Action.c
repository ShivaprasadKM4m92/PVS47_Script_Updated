Action()
{
	...
	lr_start_transaction("S03_01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='e26e580b-9d93-4c1b-860c-a68c4a973d77' Name ='Csfr_TokenId' Type ='Manual'*/
//	web_reg_save_param_attrib(
//		"ParamName=Csfr_TokenId",
//		"TagName=input",
//		"Extract=value",
//		"Name=_csrf",
//		"Type=hidden",
...
//		LAST);
	...
	lr_end_transaction("S03_01_OpenApplication",LR_AUTO);
...
//		"chrome-81.0.4044.138");
	...
	lr_start_transaction("S03_02_Login");
//
//	web_revert_auto_header("X-Goog-Update-Interactivity");
	...
	web_submit_data("authenticate",
		...
		"Mode=HTTP",
		ITEMDATA,
		"Name=_csrf", "Value={Csfr_TokenId}", ENDITEM,
...
//	
	web_url("caseByStatus", 
		"URL={URL}/signal/dashboard/caseByStatus?_=1590390412870", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t97.inf", 
	...
	web_url("sideBar", 
		"URL={URL}/signal/dashboard/sideBar?_=1590390412869", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t98.inf", 
	...
	web_url("ahaByStatus", 
		"URL={URL}/signal/dashboard/ahaByStatus?_=1590390412872", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t99.inf", 
	...
	web_url("alertByDueDate", 
		"URL={URL}/signal/dashboard/alertByDueDate?_=1590390412873", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t100.inf", 
	...
	web_url("aggAlertByStatus", 
		"URL={URL}/signal/dashboard/aggAlertByStatus?_=1590390412871", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t101.inf", 
	...
	web_url("getProductByStatus", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Aggregate%20Case%20Alert&_=1590390412875", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t102.inf", 
	...
	web_url("getProductByStatus_2", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Single%20Case%20Alert&_=1590390412874", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t103.inf", 
...
//	web_url("7435", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390412876", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/", 
//		"Snapshot=t104.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("alertList", 
		"URL={URL}/signal/dashboard/alertList?_=1590390412877", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t108.inf", 
...
//		"{URL}");
	...
	web_url("signalList", 
		"URL={URL}/signal/dashboard/signalList?_=1590390412878", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t111.inf", 
...
//
//	web_url("websocket", 
//		"URL={URL}/signal/stomp/167/94pjsuly/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t113.inf", 
//		"Mode=HTTP", 
...
//		"XMLHttpRequest");
	...
	web_url("actionList", 
		"URL={URL}/signal/dashboard/actionList?_=1590390412879", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t114.inf", 
...
//
////	web_url("7435_2", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390412880", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/", 
//		"Snapshot=t116.inf", 
...
//
	...
	lr_end_transaction("S03_02_Login",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S03_03_NavigateTriggeredAlertsQualitativeReview");
...
//	web_url("7435_3", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390485287", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/review", 
//		"Snapshot=t129.inf", 
...
//
//	web_url("websocket_2", 
//		"URL={URL}/signal/stomp/840/31v9zat8/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t131.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_4", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390485288", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/review", 
//		"Snapshot=t132.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_03_NavigateTriggeredAlertsQualitativeReview",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S03_04_ClickOnAlertName");
	...
	web_url("details", 
		"URL={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/review", 
		"Snapshot=t133.inf", 
	...
	web_url("highcharts-3d-65774008a3b78b30a394568a24c6af09.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t134.inf", 
		LAST);
...
//		"XMLHttpRequest");
	...
	web_url("viewColumnInfo", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id={ViewId}&_=1590390513634", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t160.inf", 
...
//	web_url("7435_5", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390513635", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
//		"Snapshot=t161.inf", 
...
//
//	web_url("websocket_3", 
//		"URL={URL}/signal/stomp/227/huuf984a/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t165.inf", 
//		"Mode=HTTP", 
...
//		"XMLHttpRequest");
	...
	web_submit_data("17", 
		"Action={URL}/signal/singleCaseAlert/listByExecutedConfig/17?cumulative=false&adhocRun=false&dashboardFilter=&tagName=&isFilterRequest=false&filters=[]", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t166.inf", 
...
//
//	web_url("7435_6", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390513636", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
//		"Snapshot=t170.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_04_ClickOnAlertName",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S03_05_SelectDetailedView");

	web_url("discardTempChanges", 
		"URL={URL}/signal/viewInstance/discardTempChanges?viewInstance.id={ViewId}", 
		"Resource=0", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t171.inf", 
		"Mode=HTTP", 
	...
	web_url("details_2", 
		"URL={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}", 
		"Snapshot=t172.inf", 
	...
	web_url("commonTagDetails_2", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
		"Snapshot=t173.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("viewColumnInfo_2", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id={ViewId}&_=1590390543204", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
		"Snapshot=t174.inf", 
...
//	web_url("7435_7", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390543205", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
//		"Snapshot=t175.inf", 
...
//
//	web_url("websocket_4", 
//		"URL={URL}/signal/stomp/731/1xnvnmq9/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t178.inf", 
//		"Mode=HTTP", 
//		LAST);
	...
	web_url("case_details_child_view.hbs", 
		"URL={URL}/signal/assets/app/pvs/hbs-templates/case_details_child_view.hbs", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
		"Snapshot=t179.inf", 
...
//	web_url("7435_8", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390543206", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
//		"Snapshot=t181.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_05_SelectDetailedView",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S03_06_UnSelectDetailedView");
	...
	web_url("details_3", 
		"URL={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=true", 
		"Snapshot=t183.inf", 
	...
	web_url("commonTagDetails_3", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t184.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("viewColumnInfo_3", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id={ViewId}&_=1590390566920", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t185.inf", 
...
//	web_url("7435_9", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390566921", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t186.inf", 
...
//
//	web_url("websocket_5", 
//		"URL={URL}/signal/stomp/977/xdpfcxc6/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t189.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_10", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390566922", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t190.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_06_UnSelectDetailedView",LR_AUTO);
	...
	web_url("fetchPossibleValues", 
		"URL={URL}/signal/singleCaseAlert/fetchPossibleValues?executedconfigId={ConfigId}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t191.inf", 
	...
	web_url("fetchAllFieldValues", 
		"URL={URL}/signal/singleCaseAlert/fetchAllFieldValues?isFaers=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t193.inf", 
	...
	web_url("getAllKeywords", 
		"URL={URL}/signal/query/getAllKeywords", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t198.inf", 
...
//	web_url("7435_11", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390566923", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t200.inf", 
...
//		LAST);
	...
	lr_start_transaction("S03_07_SaveFilterAndApply");
...
/*Correlation comment - Do not change!  Original value='15619' Name ='FilterId' Type ='Manual'*/
	web_reg_save_param_ex(
		"ParamName=FilterId",
		"LB={\"code\":null,\"data\":{\"id\":",
		"RB=,",
		SEARCH_FILTERS,
		"Scope=Body",
		LAST);
	...
	web_submit_data("save",
		"Action={URL}/signal/advancedFilter/save",
		"Method=POST",
		"RecContentType=application/json",
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false",
		"Snapshot=t201.inf",
	...
	web_submit_data("17_4", 
		...
		"Name=sort", "Value=selected", ENDITEM, 
		"Name=direction", "Value=asc", ENDITEM, 
		"Name=advancedFilterId", "Value={FilterId}", ENDITEM, 
...
//	web_url("7435_12", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390566924", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t204.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_07_SaveFilterAndApply",LR_AUTO);

	lr_think_time(3);

//	web_url("7435_13", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390566925", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t205.inf", 
...
//		LAST);
	...
	web_url("fetchAdvancedFilterInfo", 
		"URL={URL}/signal/advancedFilter/fetchAdvancedFilterInfo?advancedFilter.id={FilterId}", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t206.inf", 
...
//	web_url("7435_14", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390566926", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t214.inf", 
...
//		LAST);
	...
	lr_start_transaction("S03_08_Delete filter");
	...
	web_submit_data("delete", 
		"Action={URL}/signal/advancedFilter/delete", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t215.inf", 
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=id", "Value={FilterId}", ENDITEM, 
		LAST);
	...
	web_url("viewColumnInfo_4", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id={ViewId}&_=1590390656240", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t219.inf", 
...
//	web_url("7435_15", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390656241", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t220.inf", 
...
//
//	web_url("websocket_6", 
//		"URL={URL}/signal/stomp/061/bwh90nkj/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t223.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_16", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390656242", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t224.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_08_Delete filter",LR_AUTO);
	...
	web_url("viewColumnInfo_5", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id={ViewId}&_=1590390656243", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t225.inf", 
...
//	web_url("7435_17", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390656244", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
//		"Snapshot=t226.inf", 
...
//	
	...
	web_submit_data("updateViewColumnInfo", 
		"Action={URL}/signal/viewInstance/updateViewColumnInfo?viewInstance.id={ViewId}", 
		"Method=POST", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t227.inf", 
		"Mode=HTTP", 
	...
	lr_start_transaction("S03_09_SaveView");

	web_submit_data("saveView", 
		"Action={URL}/signal/viewInstance/saveView", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t229.inf", 
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=name", "Value={View_Name}", ENDITEM, 
		...
		"Name=currentViewId", "Value={ViewId}", ENDITEM, 
	...
	web_url("details_5", 
		"URL={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}&isCaseDetailView=false", 
		"Snapshot=t231.inf", 
	...
	web_url("commonTagDetails_5", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
		"Snapshot=t232.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("viewColumnInfo_6", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id=15636&_=1590390747961", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
		"Snapshot=t233.inf", 
...
//	web_url("7435_18", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390747962", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
//		"Snapshot=t234.inf", 
...
//
//	web_url("websocket_7", 
//		"URL={URL}/signal/stomp/242/f437q0zl/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t238.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_19", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390747963", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
//		"Snapshot=t239.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_09_SaveView",LR_AUTO);

	lr_think_time(3);

//	web_url("7435_20", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390747964", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
//		"Snapshot=t240.inf", 
...
//		LAST);
	...
	lr_start_transaction("S03_10_SystemView");

	web_url("discardTempChanges_5", 
		"URL={URL}/signal/viewInstance/discardTempChanges?viewInstance.id=15636", 
		"Resource=0", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
		"Snapshot=t241.inf", 
		"Mode=HTTP", 
	...
	web_url("details_6", 
		"URL={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId=15636", 
		"Snapshot=t242.inf", 
	...
	web_url("commonTagDetails_6", 
		...
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}", 
		"Snapshot=t243.inf", 
		"Mode=HTTP", 
		LAST);

	web_url("viewColumnInfo_7", 
		"URL={URL}/signal/viewInstance/viewColumnInfo?viewInstance.id={ViewId}&_=1590390778358", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}", 
		"Snapshot=t244.inf", 
...
//	web_url("7435_21", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390778359", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}", 
//		"Snapshot=t245.inf", 
...
//	web_url("websocket_8", 
//		"URL={URL}/signal/stomp/971/me40iv38/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t248.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_22", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590390778360", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleCaseAlert/details?callingScreen=review&configId={ConfigId}&viewId={ViewId}", 
//		"Snapshot=t249.inf", 
...
//		LAST);
	...
	lr_end_transaction("S03_10_SystemView",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S03_11_Logout");
	...
	lr_end_transaction("S03_11_Logout",LR_AUTO);
