...
//		"XMLHttpRequest");
	...
	web_submit_data("61", 
		"Action={URL}/signal/aggregateCaseAlert/listByExecutedConfig/{Config_Id}?callingScreen=review&cumulative=false&adhocRun=false&dashboardFilter=&tagName=&isFilterRequest=false&filters=[]&frequency=", 
		"Method=POST", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/aggregateCaseAlert/details?callingScreen=review&configId={Config_Id}", 
		"Snapshot=t162.inf", 
...
//		LAST);
	...
	web_url("caseSeriesDetails", 
		"URL={URL}/signal/singleCaseAlert/caseSeriesDetails?aggExecutionId={Config_Id}&aggAlertId={AlertId_1}&aggCountType=NEW_COUNT&productId=100077&ptCode=10037419&type=NEW&typeFlag=CUMM_FLAG", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/aggregateCaseAlert/details?callingScreen=review&configId={Config_Id}", 
		"Snapshot=t169.inf", 
...
//		LAST);
	...
	web_url("index", 
		"URL={URL}/signal/template/index?configId={Config_Id}&type=NEW&alertId=580&typeFlag=CUMM_FLAG", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer={URL}/signal/aggregateCaseAlert/details?callingScreen=review&configId={Config_Id}", 
		"Snapshot=t193.inf", 
	...
	web_url("dmsConfiguration-dd126e153d823fef612ba29b3824b193.js", 
		...
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/signal/template/index?configId={Config_Id}&type=NEW&alertId=580&typeFlag=CUMM_FLAG", 
		"Snapshot=t194.inf", 
		LAST);
...
//		"XMLHttpRequest");
	...
	web_url("getGeneratedReports", 
		"URL={URL}/signal/template/getGeneratedReports?configId={Config_Id}&alertId=580&_=1590649085944", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/template/index?configId={Config_Id}&type=NEW&alertId=580&typeFlag=CUMM_FLAG", 
		"Snapshot=t199.inf", 
...
//		LAST);
	...
	web_submit_data("changeDisposition", 
		...
		"Mode=HTTP", 
		ITEMDATA, 
		"Name=selectedRows", "Value=[{\"configObj.id\":43,\"executedConfigObj.id\":{Config_Id},\"alert.id\":{Dispose_AlertId_1}},{\"configObj.id\":43,\"executedConfigObj.id\":{Config_Id},\"alert.id\":{Dispose_AlertId_2}}]", ENDITEM, 
