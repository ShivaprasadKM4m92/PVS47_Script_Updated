Action()
{
	...
	lr_start_transaction("S12_01_OpenApplication");
...
/*Correlation comment - Do not change!  Original value='c9c65e54-8b5b-48a3-a9ef-9f05b93e42de' Name ='CsrfTokenId' Type ='Manual'*/
...
//		"AIzaSyBOti4mM-6x9WDnZIjIeyEU21OpBXqWBgw");
	...
	lr_end_transaction("S12_01_OpenApplication",LR_AUTO);
...
//		"chromecrx-81.0.4044.138");
	...
	lr_start_transaction("S12_02_Login");
...
//		"XMLHttpRequest");
	...
	web_url("ahaByStatus", 
		"URL={URL}/signal/dashboard/ahaByStatus?_=1590381530498", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t96.inf", 
	...
	web_url("caseByStatus", 
		"URL={URL}/signal/dashboard/caseByStatus?_=1590381530496", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t97.inf", 
	...
	web_url("alertByDueDate", 
		"URL={URL}/signal/dashboard/alertByDueDate?_=1590381530499", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t98.inf", 
	...
	web_url("aggAlertByStatus", 
		"URL={URL}/signal/dashboard/aggAlertByStatus?_=1590381530497", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t99.inf", 
	...
	web_url("sideBar", 
		"URL={URL}/signal/dashboard/sideBar?_=1590381530495", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t100.inf", 
...
//	web_url("7435", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381530502", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/", 
//		"Snapshot=t102.inf", 
...
//		LAST);
	...
	web_url("getProductByStatus", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Aggregate%20Case%20Alert&_=1590381530501", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t103.inf", 
	...
	web_url("getProductByStatus_2", 
		"URL={URL}/signal/dashboard/getProductByStatus?type=Single%20Case%20Alert&_=1590381530500", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t104.inf", 
...
//		"XMLHttpRequest");
	...
	web_url("alertList", 
		"URL={URL}/signal/dashboard/alertList?_=1590381530503", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t107.inf", 
...
//		"{URL}");
	...
	web_url("signalList", 
		"URL={URL}/signal/dashboard/signalList?_=1590381530504", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t109.inf", 
...
//
//	web_url("websocket", 
//		"URL={URL}/signal/stomp/250/tz_b3rl6/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t110.inf", 
//		"Mode=HTTP", 
...
//		"XMLHttpRequest");
	...
	web_url("actionList", 
		"URL={URL}/signal/dashboard/actionList?_=1590381530505", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/", 
		"Snapshot=t113.inf", 
...
//		"empty");
	...
	lr_end_transaction("S12_02_Login",LR_AUTO);
...
//	web_url("7435_2", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381530506", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/", 
//		"Snapshot=t115.inf", 
...
//		LAST);
	...
	lr_start_transaction("S12_03_NavigateOnDemandQualitative");
	...
	web_url("single_case_alert_review_adhoc-f3e426d12d0ff0f1ad6a5ea572cb0bf4.js", 
		"URL={URL}/signal/assets/app/pvs/alerts_review/single_case_alert_review_adhoc-f3e426d12d0ff0f1ad6a5ea572cb0bf4.js", 
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/signal/singleOnDemandAlert/adhocReview", 
		"Snapshot=t121.inf", 
...
//	web_url("7435_3", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381561722", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleOnDemandAlert/adhocReview", 
//		"Snapshot=t128.inf", 
...
//	web_url("websocket_2", 
//		"URL={URL}/signal/stomp/392/cnwt0gtq/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t132.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_4", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381561724", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleOnDemandAlert/adhocReview", 
//		"Snapshot=t133.inf", 
...
//		LAST);
	...
	lr_end_transaction("S12_03_NavigateOnDemandQualitative",LR_AUTO);

	lr_think_time(3);

//	web_url("7435_5", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381561725", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/singleOnDemandAlert/adhocReview", 
//		"Snapshot=t134.inf", 
...
//		LAST);
	...
	lr_start_transaction("S12_04_NavigateOnDemandQuantitative");
	...
	web_url("agg_case_adhoc_review-a2039df8bc0a9bcb8180550275c3b094.js", 
		"URL={URL}/signal/assets/app/pvs/alerts_review/agg_case_adhoc_review-a2039df8bc0a9bcb8180550275c3b094.js", 
		"Resource=1", 
		"RecContentType=application/javascript", 
		"Referer={URL}/signal/aggregateOnDemandAlert/adhocReview", 
		"Snapshot=t137.inf", 
...
//	web_url("7435_6", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381581628", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/aggregateOnDemandAlert/adhocReview", 
//		"Snapshot=t141.inf", 
...
//
//	web_url("websocket_3", 
//		"URL={URL}/signal/stomp/470/fvnqt_ht/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t145.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_7", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381581630", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/aggregateOnDemandAlert/adhocReview", 
//		"Snapshot=t146.inf", 
...
//		LAST);
	...
	lr_end_transaction("S12_04_NavigateOnDemandQuantitative",LR_AUTO);

	lr_think_time(3);

//	web_url("7435_8", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381581631", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/aggregateOnDemandAlert/adhocReview", 
//		"Snapshot=t147.inf", 
...
//		LAST);
	...
	lr_start_transaction("S12_05_NavigateOnDemandEVDAS");
	...
	web_url("evdas_alert_adhoc_review-7657a0ec2e1513e05268328368cb7b7f.js", 
		"URL={URL}/signal/assets/app/pvs/alerts_review/evdas_alert_adhoc_review-7657a0ec2e1513e05268328368cb7b7f.js", 
		"Resource=1", 
		"RecContentType=application/javascript", 
...
//
//	web_url("7435_9", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381600941", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/evdasOnDemandAlert/adhocReview", 
//		"Snapshot=t153.inf", 
...
//		LAST);
	...
	web_url("listAdhocConfig", 
		"URL={URL}/signal/evdasOnDemandAlert/listAdhocConfig?_=1590381600942", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer={URL}/signal/evdasOnDemandAlert/adhocReview", 
		"Snapshot=t155.inf", 
...
//	web_url("websocket_4", 
//		"URL={URL}/signal/stomp/241/zxjxilya/websocket", 
//		"Resource=0", 
//		"Referer=", 
//		"Snapshot=t157.inf", 
//		"Mode=HTTP", 
...
//	web_url("7435_10", 
//		"URL={URL}/signal/inboxLog/forUser/7435?_=1590381600943", 
//		"Resource=0", 
//		"RecContentType=application/json", 
//		"Referer={URL}/signal/evdasOnDemandAlert/adhocReview", 
//		"Snapshot=t158.inf", 
...
//		LAST);
	...
	lr_end_transaction("S12_05_NavigateOnDemandEVDAS",LR_AUTO);

	lr_think_time(3);

	lr_start_transaction("S12_06_Logout");
	...
	lr_end_transaction("S12_06_Logout",LR_AUTO);
